// launch with node simulator/sim_v3.js
...
const turnAverage = sumTurns/numberOfGames
const winAverage = numberOfGames-losses/numberOfGames

console.log('Average win rate: '+ winAverage)
console.log('Average win turns: '+ turnAverage)
